...
Pod::Spec.new do |s|
  s.name             = 'GHBaseModule'
  s.version          = '0.1.0'
  s.summary          = 'A short description of GHBaseModule.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/haoguanhao/GHBaseModule'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'haoguanhao' => '1101895317@qq.com' }
  s.source           = { :git => 'https://github.com/haoguanhao/GHBaseModule.git', :tag => s.version.to_s }
